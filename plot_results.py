...
#                                      index_col=0)
data_frame["Weak Model Error"] = pd.read_csv("model_error.csv", header=0, 
                                             index_col = 0)
data_frame["Ensemble Error"] = pd.read_csv("boosting_error.csv", header=0, index_col=0)


ax.set_xlabel("Iterations")
ax.set_ylabel("Percentage")

data_frame.plot(ax=ax, color=[ "#D55E00", "#A60628", "#348ABD"])  # COMBINED
